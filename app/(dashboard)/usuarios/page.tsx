...
import { Plus, Edit, Trash2, User, UserCheck, UserX, Shield } from 'lucide-react'
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold">Gestión de Usuarios y Membresías</h1>
          <p className="text-muted-foreground">
            Administra usuarios del sistema y sus membresías en instituciones
          </p>
        </div>
      </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Gestiona los roles de usuarios en instituciones
                </CardDescription>
              </div>
              <Dialog 
